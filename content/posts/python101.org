...
{{< initial >}}
Python is well known *scripting language*. We will see more about scripting languages further. At a time of writing this python is available in /version 3.10/. You can download from official website of [[https://www.python.org/downloads/][python]]. In this series, i'll go from simple installation to more subtle topics. My idea of audience will be of new students who wanna try python or a science students who starting to learn python or tinker who wanna automate daily stuff in python.
{{< /initial >}}
